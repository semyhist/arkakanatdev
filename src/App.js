...
const team = {
  ...
  admin: [
    ...
    { name: 'Mehmet Selim', bio: '', emoji: '🌹' },
    { name: 'Ela', bio: '@oscarpiyastri', emoji: '🧊' },
    { name: 'Azra', bio: '@ferrarisefiri', emoji: '🏎️' },
    { name: 'Yunus Emre', bio: '@orek.edits', emoji: '🏎️' },
    { name: 'Yağız', bio: '@vettelsexuel', emoji: '🏎️' },
  ],
  Twitter: [
    { name: 'Utku', bio: 'Haber Departmanı yetkilisi.', emoji: '💻' },
    { name: 'M. Furkan', bio: 'Haber Departmanı yetkilisi.', emoji: '🐙' },
